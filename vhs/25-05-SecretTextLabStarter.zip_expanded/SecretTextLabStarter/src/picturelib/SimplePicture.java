...
public class SimplePicture implements DigitalPicture
{
  ...
  // VHS - keep the massive amount of pics in the images folder.
  private static final String LOAD_FOLDER_PATH_PREFIX =
    "src" + File.separator + "images" + File.separator;

  private static final String WRITE_FOLDER_PATH_PREFIX =
    "src" + File.separator + "output" + File.separator;
   ...
   * 200 and a height of 100 that is all white. A no-argument constructor must
   * be given in order for a class to be able to be subclassed. By default all
  ...
  public SimplePicture(String fileName)
  {
    ...
    load(LOAD_FOLDER_PATH_PREFIX + fileName); // VHS
  ...
  public void loadOrFail(String fileName) throws IOException
  {
    ...
    File file = new File(this.fileName); // VHS
  ...
  public Picture scale(double xFactor, double yFactor)
  {
    ...
    Picture result =
      new Picture((int) (getWidth() * xFactor), (int) (getHeight() * yFactor));
  ...
  public void writeOrFail(String fileName) throws IOException
  {
    ...
    fileName = WRITE_FOLDER_PATH_PREFIX + fileName; // VHS
  ...
  {
    String output =
      "Simple Picture, filename " + fileName + " height " + getHeight()
        + " width " + getWidth();
    return output;
  }
